...
int main() {
  ...
  GitClean();
  RunCommand(git, ['reset', '--hard','1bee6c5eb5a29d62ce0ea32b044787752fccfd20'], workingDirectory: wd_git, environment:env);
...
["unzpaq101.cpp", "", ["unzpaq1.cpp"],
  "zpaq v1.01, Updates reference decoder comments and help message and fixes some VS2005 compiler issues. Compatible with 1.00. Apr. 27, 2009.", "2009-04-27 17:37:07.000Z"],
["zpaq102.zip", "", true,
  "zpaq v1.02, Closes extracted files immediately after decompression instead of when program exits. Fixes g++ 4.4 warnings. Compatible with 1.00 and 1.01. June 14, 2009."],
//<a href=unzpaq102.cpp>unzpaq 1.02</a>
["zpaq103a.zip", "", true,
  "zpaq v1.03a, has a default compression mode (mid.cfg), supports compressing files in segments to separate blocks and extracting them as suggested in part 7 of the spec. Does not store paths by default. Does not extract to absolute paths by default. Some minor improvements. Sept. 7, 2009 (added zpaq.exe Sept. 8, 2009)."],
//<a href=unzpaq103.cpp>unzpaq 1.03</a>
["zpaq103b.zip", "", true,
  "zpaq v1.03b, adds zpaqsfx 1.03, a stub for creating self extracting archives. No changes to zpaq or unzpaq. Sept. 14, 2009."],
["zpaq104.zip", "", true,
  "zpaq v1.04, Can list and extract from self extracting archives without running them. Added progress meter. zpaqsfx.exe stub is slightly smaller. unzpaq unchanged. Sept. 18, 2009."],
["zpaq105.zip", "", true,
  "zpaq v1.05, Removes built in x and p preprocessors and makes them separate programs called from config files with compile time postprocessor testing. Adds if-else-endif and do-while to ZPAQL. Many small changes. Sept. 28, 2009."],
["zpaq106.zip", "", true,
  'zpaq v1.06, adds "ta" to append locater tags to allow ZPAQ streams to be detected when embedded in arbitrary data. Sept. 29, 2009.'],
/*
["zpaq1.pdf", "", true,
...
["zpaqsfx106.zip", "", false,
  "zpaqsfx 1.06 self extracting archive stub is now separate from the ZPAQ distribution. Updated Sept. 29, 2009, posted Oct. 26, 2009. (Replaced by zpsfx in libzpaq 2.01)", "2009-09-30 00:08:44.000Z"],
["zpaq107.zip", "", ['zpaq106.cpp'],
  "zpaq v1.07, adds config file parameters and fixes some bugs. From now on the specification and reference decoder are not included unless they change. Oct. 2, 2009."],
...
["zpaq108.zip", "", ['zpaq107.cpp'],
  "zpaq v1.08, generates optimized code that runs about twice as fast on systems with a C++ compiler installed. Oct. 14, 2009."],
...
["zpaq109.zip", "", false,
  "zpaq v1.09, Linux port and some cosmetic bug fixes. Oct. 21, 2009."],
["zpaq110.zip", "", false,
  "zpaq v1.10, bug fix for Linux/g++ 4.4.1, Dec. 28, 2009.", "2009-12-29 03:11:12.000Z"],
["zpipe100.zip", "", false,
  "zpipe v1.00, a simple streaming compressor, Sept. 30, 2009. Linux patch added Jan. 18, 2010.", "2010-01-18 17:00:08.000Z"],
//<a href=fast.cfg>fast.cfg</a> written Apr. 26, 2010. Now part of libzpaq distribution.<br>
["fast.cfg", "", false,
    "fast.cfg written Apr. 26, 2010. Now part of libzpaq distribution.", "2010-04-27 01:00:08.000Z"],
["zp100.zip", "", false,
  "zp v1.00 simple ZPAQ compatible archiver with 3 optimized compression levels, Apr. 26, 2010.", "2010-04-27 02:00:08.000Z"],
...
["libzpaq200.zip", "", ['unzpaq108.cpp', 'zpaq.h', 'demo1.cpp', 'demo2.cpp'],
  "zpaq v2.00, Oct. 30, 2010. Ports zpaq to libzpaq, replacing zp."],
["libzpaq201.zip", "", false,
  "zpaq v2.01, Nov. 5, 2010. Added optimized self extracting archives. Simplified installation."],
["libzpaq202.zip", "", false,
  "zpaq v2.02, Nov. 13, 2010. zpaq shows compression component statistics. Libzpaq support added."],
["zpaq.203.zip", "", false,
  "zpaq v2.03, Dec. 23, 2010, adds Linux support. The remaining code is split into libzpaq 2.02, zpipe 2.01, zpsfx 1.00, and configuration files min, fast, mid, and max."],
...
["zpaq.204.zip", "", false,
  "zpaq v2.04, Dec.29, 2010, adds support for Visual C++, Borland, and Mars compilers in addition to g++. A Windows install script is added."],
["zpaq.205.zip", "", false,
  "zpaq v2.05, Jan. 5, 2011. Fixed a bug in which zpaq crashed when decompressing an unnamed file (as created with zpipe or zpaq nc) without renaming. Separated zpaq.1.pod. (Updated corrupted install.sh on Jan. 13, 2011)."],
["libzpaq.202a.zip", "", false,
  "libzpaq 2.02a, Jan. 6, 2011. Updates the documentation.", "2011-01-06 16:01:35.000Z"],
["pzpaq.001.zip", "", false,
...
["unzp.100.zip", "", false,
  "unzp 1.00, May 10, 2011, a block level parallel decompresser optimized for fast, mid, max, bwtrle1, bwt2 models with source level JIT for other models.", "2011-05-10 21:02:06.000Z"],
["zp.101.zip", "", false,
  "zp 1.01, May 12, 2011, a block level parallel compressor with 4 levels (bwtrle1, bwt2, mid, max). With unzp replaces pzpaq."],
["zp.102.zip", "", false,
  "zp 1.02, May 16, 2011. Fixed -t option. May 18, 2011. Undated zp.102.zip and unzp.100.zip with static x86-64 Linux binaries.", "2011-05-17 01:54:43.000Z"],
["zp.103.zip", "", false,
...
["zpaq300.zip", "", false,
  "zpaq v3.00, July 16, 2011. Combines features of zpaq v2.05 and zp v1.03. zp support is discontinued. Windows only."],
["zpaq301.zip", "", false,
  "zpaq v3.01, July 21, 2011. Adds 64 bit Linux support. Includes libzpaq 3.00."],
...
["zpaq400.zip", "", false,
  "zpaq v4.00, Nov. 13, 2011. zpaq.cpp, zpaq.1.pod for use with libzpaq 4.00. Removes source generation, b and e commands and -j option.", "2011-11-13 16:00:20.000Z"],
//<a href=calgarytest.zpaq>calgarytest.zpaq</a>, Nov. 13, 2011.  Test case for ZPAQ compliance.<br>
["zpipe.201.zip", "", false,
  "zpipe v2.01, Nov. 13, 2011. zpipe.exe linked to libzpaq v4.00. Source unchanged.", "2011-11-13 17:53:59.000Z"],
["zpaq401.zip", "", false,
...
["unzpaq200.cpp", "", false,
  "Feb. 1, 2012 unzpaq200.cpp reference decoder"],
["libzpaq500.zip", "", false,
  "Feb. 1, 2012 libzpaq 5.00 support, Level 2 allows the COMP section to be empty to store uncompressed (but possibly preprocessed) data to support faster compression models."],
...
["zpaq643.zip", "", true,
  "zpaq v6.43, Dec. 20, 2013. Adds -key (encryption), show, sha1, sha256 commands. Updates libzpaq to v6.43 (adds AES, SHA256, Scrypt)"],
["zpaq644.zip", "", true,
  "zpaq v6.44, Jan. 9, 2014. Adds encrypt command, removes restore, show, sha1, sha256, changes extract to skip existing files instead of error, changes purge syntax, prompt for passwords without echo, faster -method 5, some minor bug fixes."],
["zpaq645.zip", "", true,
  "zpaq v6.45, Jan. 12, 2014. Improves compression by sorting files by case insensitive extension, then by decreasing size rounded to 16K. Fixed VC++ compile error in 6.44."],
//<a href=zpaq203.pdf>zpaq203.pdf</a>, Jan. 16, 2014. Level 2 revision 3 of the specification adds encryption.<br>
["zpaq646.zip", "", true,
  "zpaq v6.46, Jan. 17, 2014. Improved compare, added -fragment option. Fixed extracting streaming encrypted archives."],
["zpaq647.zip", "", true,
  "zpaq v6.47, Jan. 21, 2014. Adds snip command to support remote backups. Extends -since to extract and compare. Increased compression buffers for better core utilization."],
["zpaq648.zip", "", true,
  "zpaq v6.48, Jan. 23, 2014. Adds join command. Renames snip to split. Optimized decoder in libzpaq.cpp 6.48."],
["zpaq649.zip", "", true,
  "zpaq v6.49, Jan. 31, 2014. Adds progress indicator and other UI improvements. test can take filename args. libzpaq.cpp 6.49 and Makefile to fix Mac OS/X compiler warnings."],
["zpaq650.zip", "", true,
  "zpaq v6.50, Mar. 21, 2014. Reduced compression levels to -method 0..5 with better compression. Added -nodelete. Remove encrypt command, replaced with purge -all -newkey. Supports split archives directly, replacing split and join commands."],
];
